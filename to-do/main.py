...
# + 1. Add to ToReadItem with header and url fields.
# + 2. Add command "done"
# + 3. Any list member with done = True must be returned in list with "+", done = False with "-".
# + 4. Add command "undone"